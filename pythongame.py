...
root.title("Gaurav Presents Tic Tac Toe")
root.configure(background = 'blue')
Tops = Frame(root,bg = 'blue',pady = 2, width =1350, height = 100, relief = RIDGE)
Tops.grid(row=0,column=0)
flag =0

lblTitle = Label(Tops,font=('arial',50,'bold'),text = "Gaurav Presents Tic Tac Toe",bd = 21,fg='white', bg='blue',justify = CENTER)
...
def scorekeeper():
		...
		if (button1["text"] == "X" and button2["text"] == "X" and button3["text"] == "X"):
			...
			tkinter.messagebox.showinfo("Gaurav Tic Tac Toe",pa)
			reset()
		...
		if (button1["text"] == "O" and button2["text"] == "O" and button3["text"] == "O"):
			...
			tkinter.messagebox.showinfo("Gaurav Tic Tac Toe",pb)
			reset()
